function About() {
  ...
  return (
    <main className="bg-slate-950 text-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-950 via-slate-950 to-cyan-950 px-6 py-20 sm:py-24">
      ...
      {/* Mission and Vision */}
      <section className="border-y border-slate-800 bg-slate-900/50 px-6 py-16 sm:py-24">
      ...
      <section className="border-y border-slate-800 bg-slate-900/50 px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <article className="rounded-2xl border border-slate-800 bg-slate-950 p-7">
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-blue-950 to-cyan-950 px-6 py-16">
